<!DOCTYPE html>
<?php
 // Se agregan productos al arreglo , o la base de datos 
// canbiando las variables
...
<head>
    ...
    <meta name="Cesar Garcia Zamarripa" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 210 6687</a></li>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								Echo por: Cesar Garcia Zamarripa 
								// se agrega un nuevo documento que almacena los datos 
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<h4 class="panrl-title"><a href="#">Caballeros</a></h4>
								</div>
							</div>
										...
										<div class="productinfo text-center">
			                             ...
			                             ?>
											...
											<h2>
												...
												echo " $ " . $BDProductos[$n+2]; 
												?>
											</h2>
											<p><?php 
											// Se cambian las variables 
											echo " $ " .  $BDProductos [$n+1]; ?>
											 </p>
